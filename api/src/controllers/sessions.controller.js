...
export const cookieController = async req => {
    if (!(req && req.signedCookies)) {throw new ApiError('No authentication', 401)}
    return req.signedCookies['cookieToken']
}


export const jwtController = (jwt_payload, done) => {
    try {
